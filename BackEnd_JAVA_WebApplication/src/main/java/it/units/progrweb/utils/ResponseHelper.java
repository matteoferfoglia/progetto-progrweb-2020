 ...
 * Status intuibile dal nome dei metodi e messaggio (entity)
 * atteso come parametro. Potrebbero essere richiesti ulteriori
 * parametri intuibili dalla firma del metodo.
 *
...
public class ResponseHelper {
    ...
    /** Dati messaggio  Response.Status e cookie, restituisce l'oggetto
    ...
    /** Dati messaggio e  Response.Status, restituisce l'oggetto
     * {@link Response} corrispondente, con {@link MediaType} {@link MediaType#TEXT_PLAIN}.*/
    ...
    /** Dati messaggio,  Response.Status, {@link MediaType}, {@link HeaderResponse} e {@link Cookie Cookie[]},
    ...
    /** Dati messaggio e Status, restituisce l'oggetto
     * ResponseBuilder corrispondente, impostando i campi
