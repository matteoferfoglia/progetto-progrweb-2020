  ...
  <header>
    <nav>
      ...
      <div id="containerOpzioniUtente" v-if="isAutenticato()">
        ...
        <ul id="elencoOpzioniUtente">

          <!-- TODO <div v-if="isAdministrator()">

            <li>
              <router-link>Gestione Consumer</router-link>
            </li>

            <li>
              <router-link>Gestione Uploader</router-link>
            </li>

            <li>
              <router-link>Gestione Administrator</router-link>
            </li>
