...
public class RelazioneUploaderConsumerFileTest {
    ...
    void testMappa_idAttore_arrayIdFiles(){
        ...
        Map<Long,Long[]> mappaCalcolata_IdConsumer_IdFile = RelazioneUploaderConsumerFile.mappa_idConsumer_arrayIdFile(risultatoQuerySimulato);
        ...
        Map<Long,Long[]> mappaCalcolata_IdUploader_IdFile = RelazioneUploaderConsumerFile.mappa_idUploader_arrayIdFile(risultatoQuerySimulato);
     ...
     * {@link RelazioneUploaderConsumerFile#mappa_idConsumer_arrayIdFile(List)}
     * oppure da {@link RelazioneUploaderConsumerFile#mappa_idUploader_arrayIdFile(List)}.*/
        ...
        Arrays.stream(fieldsRelazione).forEach( field -> {
            ...
            try {
                switch( field.getName() ) {
                    ...
                    case "idUploader"  : field.set(r, idUploader); break;
                    case "idConsumer"  : field.set(r, idConsumer); break;
